...
app = Flask(__name__)
# app.config["MAIL_DEFAULT_SENDER"] = "carbonfootprintcalc@yahoo.com"
# app.config["MAIL_PASSWORD"] = "Changu@123"
# app.config["MAIL_PORT"] = 587
# app.config["MAIL_SERVER"] = "smtp.mail.yahoo.com"
# app.config["MAIL_USE_TLS"] = True
# app.config["MAIL_USERNAME"] = "carbonfootprintcalc@yahoo.com"
# app.config["MAIL_SERVER"] = "106.10.139.35"
# mail = Mail(app)
...
def log():
    ...
    if request.method == "POST":
        ...
        food_carbon = round(6*int(3*int(request.form.get("chicken"))), 2)
